...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    //[self.delegate setAsset:self.assetsFetchResults[indexPath.item]];
    //[self.delegate setAssetCollection:self.assetCollection];
   // [self.navigationController popToRootViewControllerAnimated:YES];
    //  GalleryViewController *assetViewController = segue.destinationViewController;
